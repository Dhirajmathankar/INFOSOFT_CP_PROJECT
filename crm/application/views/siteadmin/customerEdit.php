        ...
        <div class="row ">
            <div class="col-12  align-self-center">
                <div class="sub-header mt-4 align-self-center d-sm-flex w-100 rounded">
                    <div class="w-sm-100 mr-auto"><h4 class="mb-0">Customer Master [Edit]</h4></div>
            ...
            <div class="col-12 col-lg-12 mt-1">
                ...
                <div class="card">
                    <div class="card-header">                               
                        <h4 class="card-title" style="color: #fff;">Customer Master [Edit]</h4>                                
                    </div>
                            ...
                            <form class="form-row" action="<?php echo base_url()."superadmindashbord/customerUpdate"; ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group col-sm-4 mb-2">
                                  <div class="form-group">
                                    ...
                                    <textarea rows="2" name="customerName" class="form-control font-w-600 text-primary"><?php echo $row->customerName ;?></textarea>
                                  </div>
                                </div>
                                ...
                                <div class="form-group col-sm-4 mb-2">
                                  <div class="form-group">
                                    <label>PIN Code:</label>
                                     <input type="text" value="<?php echo $row->customerPINCode ;?>" class="form-control"  name="customerPINCode" >
                                  </div>
                                </div>
                                <div class="form-group col-sm-4 mb-2">
                                  <div class="form-group">
                                    <label>Mobile No. (Primary):</label>
                                     <input type="text" value="<?php echo $row->customerMobileNo ;?>" onkeyup="phone_validate(this.value);" class="form-control" name="customerMobileNo">
                                ...
                                <div class="form-group col-sm-4 mb-2">
                                  <div class="form-group">
                                    <label>Mobile No. (Alternate):</label>
                                     <input type="text" value="<?php echo $row->customerMobileNo1 ;?>" onkeyup="phone_validate1(this.value);" class="form-control" name="customerMobileNo1">
                                ...
                                <div class="form-group col-sm-4 mb-2">
                                  <div class="form-group">
                                    <label>Email ID:</label>
                                     <input type="email" value="<?php echo $row->customerEmailID ;?>" class="form-control" name="customerEmailID">
                                  </div>
                                </div>
                                <div class="form-group col-sm-4 mb-2">
                                  <div class="form-group">
                                    <label>Customer GST No.:</label>
                                     <input type="text" value="<?php echo $row->customerGSTNo ;?>" class="form-control" name="customerGSTNo">
                                  </div>
                                </div>
                                <div class="form-group col-sm-4 mb-2">
                                  <div class="form-group">
                                    <label>Customer Adhaar No.:</label>
                                     <input type="text" value="<?php echo $row->customerAdhaarNo ;?>" class="form-control" name="customerAdhaarNo">
                                  </div>
                                </div>
                                <div class="form-group col-sm-4 mb-2">
                                  <div class="form-group">
                                    <label>Customer PAN No.:</label>
                                     <input type="text" value="<?php echo $row->customerPANNo ;?>" class="form-control" name="customerPANNo">
                                  </div>
                                </div>
                                <div class="form-group col-sm-4 mb-2">
                                  <div class="form-group">
                                    <label>Opening Balance:</label>
                                     <input type="text" value="<?php echo $row->customerOpeningBalance ;?>" class="form-control" name="customerOpeningBalance">
                                  </div>
                                </div>
                                <div class="form-group col-sm-4 mb-2">
                                  <div class="form-group">
                                    <label>Closing Balance:</label>
                                     <input type="text" value="<?php echo $row->customerClosingBalance ;?>" class="form-control" name="customerClosingBalance">
                                  </div>
                                </div>
                                <div class="form-group col-sm-4 mb-2">
                                  <div class="form-group">
                                    <label>Bank Account No:</label>
                                     <input type="text" value="<?php echo $row->bankAccountNo ;?>" class="form-control" name="bankAccountNo">
                                  </div>
                                </div>
                                <div class="form-group col-sm-4 mb-2">
                                  <div class="form-group">
                                    <label>Bank Account IFSC Code:</label>
                                     <input type="text" value="<?php echo $row->bankifscCode ;?>" class="form-control" name="bankifscCode">
                                  </div>
                                </div>
                                <div class="form-group col-sm-4 mb-2">
                                  <div class="form-group">
                                    <label>Party Type:</label>
                                     <select class="select2 form-control" name="partyType">
                                        <option value="" disabled="">---select---</option>
                                        <option value="NA"<?php if ($row->partyType=='NA') { echo 'selected';
                                    } ?>>N.A.</option>
                                        <option value="GST Dealer"<?php if ($row->partyType=='GST Dealer') { echo 'selected';
                                    } ?>>GST Dealer</option>
                                        <option value="Un-Registered Person"<?php if ($row->partyType=='Un-Registered Person') { echo 'selected';
                                    } ?>>Un-Registered Person</option>
                                        <option value="Composition Dealer"<?php if ($row->partyType=='Composition Dealer') { echo 'selected';
                                    } ?>>Composition Dealer</option>
                                        <option value="UIN Holder"<?php if ($row->partyType=='UIN Holder') { echo 'selected';
                                    } ?>>UIN Holder</option>
                                    </select>
                                  </div>
                                </div>
                                ...
                                <div class="form-group col-sm-4 mb-2"> 
                                  ...
                                  <input style="background: aliceblue;" readonly="" type="text" class="form-control" name="createdDateCustomer" value="<?php echo $row->createdDateCustomer ;?>">
                                </div>
                                <div class="form-group col-sm-12 mt-3" style="text-align: center; margin: 0px;"> 
                                    <button onclick="return confirm('Are you sure you want to Update Customer info?')" title="Update" type="submit" name="submit" class="btn btn-info"><i class="fas fa-save"></i> Update</button>  
                                </div>
                            </form> 
                        </div>
                    </div>
