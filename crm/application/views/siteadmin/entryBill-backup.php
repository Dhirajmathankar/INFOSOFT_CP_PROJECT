...
<table width="100%">
    ...
    <tbody>
        ...
        <tr>
            <th colspan="8" class="text-primary" style="text-align: right;font-size: 18px;"><span id="gststate" style="display: none;" >Total GST Amount:</span> <span id="igst" style="display: none;">Total IGST Amount:</span>
...
// variables for creating  bill record and storing values
    ...
    var qtyTotal=0;
    var priceTotal=0;
    var cgstAmountTotal=0;
    var sgstAmountTotal=0;
    ...
    <tr>
            ...
            <td class="text-primary">
              <input type="text" class="form-control font-w-600 unit"  id="unit">
            </td>
            <td class="text-primary">
                <input type="text" placeholder="" class="form-control font-w-600 price" onkeyup="expensesSum1();" id="price" style="text-align: right;">
            </td>
            <td class="text-primary">
                <input type="text" class="form-control font-w-600 cgst" onkeyup="expensesSum1();" id="cgst">
            </td>
            
            <td class="text-primary">
              <input type="text" placeholder="" class="form-control font-w-600 cgstamount" onkeyup="expensesSum1();" style="text-align: right;" id="cgstamount" value="0.00">
            </td>
            <td class="text-primary">
                <input type="text" class="form-control font-w-600 sgst" onkeyup="expensesSum1();" id="sgst">
            </td>
            
            <td class="text-primary">
              <input type="text" placeholder="" class="form-control font-w-600 sgstamount"  onkeyup="expensesSum1();" style="text-align: right;" id="sgstamount" value="0.00">
            </td>
    ...
    var cgst= billRecord[i]["cgst"];
    var cgstTotal= billRecord[i]["cgstTotal"];
    var sgst=billRecord[i]["sgst"];
    var sgstAmount= billRecord[i]["sgstAmount"];
    var total=  billRecord[i]["total"];
    
    qtyTotal= qtyTotal+ parseFloat(qty);
    priceTotal=priceTotal+ parseFloat(price);
    cgstAmountTotal=cgstAmountTotal+parseFloat(cgstTotal);
    sgstAmountTotal=parseFloat(sgstAmountTotal)+parseFloat(sgstAmount);
    ...
    <tr>
            ...
            <td class="text-primary">
              <input type="text" class="form-control font-w-600 unit"  id="unit`+i+`" value="`+unit+`">
            </td>
            <td class="text-primary">
                <input type="text" placeholder="" class="form-control font-w-600 price" onkeyup="expensesSum1();" id="price`+i+`" style="text-align: right;" value="`+price+`">
            </td>
            <td class="text-primary">
                <input type="text" class="form-control font-w-600 cgst" onkeyup="expensesSum1();" id="cgst`+i+`" value="`+cgst+`">
            </td>
            
            <td class="text-primary">
              <input type="text" placeholder="" class="form-control font-w-600 cgstamount" onkeyup="expensesSum1();" style="text-align: right;" id="cgstamount`+i+`"  value="`+cgstTotal+`">
            </td>
            <td class="text-primary">
                <input type="text" class="form-control font-w-600 sgst" onkeyup="expensesSum1();" id="sgst`+i+`" value="`+sgst+`">
            </td>
            
            <td class="text-primary">
              <input type="text" placeholder="" class="form-control font-w-600 sgstamount"  onkeyup="expensesSum1();" style="text-align: right;" id="sgstamount`+i+`" value="`+sgstAmount+`">
            </td>
            <td class="text-primary" style="display: flex;">
    ...
    gSTAmountTotal=parseFloat(cgstAmountTotal)+parseFloat(sgstAmountTotal);
    ...
    $("#cgstTotal").val(cgstAmountTotal);
    $("#sgstTotal").val(sgstAmountTotal);
...
function addBillRecord(){
    ...
    var price= $("#price").val();
    var cgst=$("#cgst").val();
    var cgstTotal=$("#cgstamount").val();
    var sgst=$("#sgst").val();
    var sgstAmount=$("#sgstamount").val();
    var total= $("#total").val();

   var res= addBillToArray(pid,product_name, qty, unit, price, cgst, cgstTotal, sgst, sgstAmount, total );
   if(res){
    billRecordView();
   }
...
function addBillToArray(pid,product_name, qty, unit, price, cgst, cgstTotal, sgst, sgstAmount, total ){
...
function finalSubmitBill(){
    ...
    var data={
        ...
        "cgstAmountTotal":cgstAmountTotal,
        "sgstAmountTotal":sgstAmountTotal,
        "grossAmountTotal":grossAmountTotal,
        "taxableAmountTotal":taxableAmountTotal,
        "gSTAmountTotal":gSTAmountTotal,
