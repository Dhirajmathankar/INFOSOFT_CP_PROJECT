                ...
                <div class="row ">
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-4 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">Bill [Payment Done]</h4>
                              ...
                              <span title="Current Status: <?php if ($row->statusPayment=="Pending"){ echo 'Pending'; } ?><?php if ($row->statusPayment=="Done"){ echo 'Payment Done'; } ?>"> Current Status: <?php if ($row->statusPayment=="Pending"){ echo 'Pending'; } ?><?php if ($row->statusPayment=="Done"){ echo 'Payment Done'; } ?></span></span>  
                            ...
                            <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                                ...
                                <li class="breadcrumb-item active">Bill [Payment Done]</li>
                            </ol>
                        </div>
                    </div>
                </div>
