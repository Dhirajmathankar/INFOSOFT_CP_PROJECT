                ...
                <div class="row ">
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-4 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">Order Booking [Bill Generated]</h4>
                              ...
                              <span title="Bill Status: <?php if ($fetch->statusBill=="Pending"){ echo 'Pending'; } ?><?php if ($fetch->statusBill=="Done"){ echo 'Bill Generated'; } ?>"> Bill Status: <?php if ($fetch->statusBill=="Pending"){ echo 'Pending'; } ?><?php if ($fetch->statusBill=="Done"){ echo 'Bill Generated'; } ?></span></span>  
                            ...
                            <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                                ...
                                <li class="breadcrumb-item active">Order Booking [Bill Generated]</li>
                            </ol>
                        </div>
                    </div>
                </div>
