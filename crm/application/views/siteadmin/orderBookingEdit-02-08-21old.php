                        ...
                        <div class="card mt-2">
                            ...
                            <div class="card-content ">
                                <div class="card-body py-3 form-row">
                                      ...
                                      <input type="hidden" name="obid" value="<?php echo $fetch[0]->obid ;?>">


                                       <div class="form-group col-sm-6 mb-2"> 
                                            <label for="dt"> Order Booking No.:</label> 
                                            <input title="Order Booking No." readonly="" type="text" class="form-control font-w-600 text-danger" name="orderBookingNo" value="<?php echo $fetch[0]->orderBookingNo; ?>" style="background: aliceblue;">
                                        </div>

                                       <div class="form-group col-sm-3 mb-2"> 
                                            <label for="dt"> Booking Date:</label> 
                                            <input title="Booking Date" type="date" required="" class="form-control font-w-600 text-danger" name="bookingDate" value="<?php echo date("Y-m-d", strtotime($fetch[0]->bookingDate)); ?>" style="background: aliceblue;">
                                        </div>

                                        <div class="form-group col-sm-3 mb-2"> 
                                            <label for="dt"> Total Bill Amount (<i class="fas fa-rupee-sign" style="font-size: 12px;"></i>):</label> 
                                            <input title="Total Bill Amount" type="text" placeholder="" class="form-control text-danger font-w-600" name="totalBillAmt" id="totalBillAmt" value="<?php echo $fetch[0]->totalBillAmt; ?>" required="" readonly="" style="background: aliceblue;text-align: center;">
                                        </div>
                                            ...
                                            <tr>
                                                 <td class="text-primary">
                                                  <select class="select2 form-control" name="cuid" required="">
                                                      ...
                                                      <?php  echo customerDropdown($fetch[0]->cuid); ?> 
                                                  </select>
                                                 </td>
                                                 ...
                                                 <td class="text-primary">
                                                  <select class="select2 form-control" name="brid" required="">
                                                      <option value="" selected="" disabled="">---select---</option> 
                                                      <?php  echo brokerDropdown($fetch[0]->brid); ?> 
                                                  </select>
                                                 </td>
                                            </tr>
                                        ...
                                        <tbody>
                                          ...
                                          <!-- multi select loop start -->
                                            <tr>
                                                <td class="text-primary">
                                                   <?php echo $sno;?>
                                                   <input type="hidden" class="form-control" name="oblistid[]" value="<?php echo $value[0]->oblistid ;?>">
                                                 </td>
                                                 <td class="text-primary">
                                                   <input style="width: 157px; font-size: 14px;" type="date" placeholder="" class="form-control font-w-600 text-danger" name="orderDate[]" id="orderDate<?php echo $sno;?>"   value="<?php echo date("Y-m-d", strtotime($value->orderDate)); ?>">
                                                 </td>
                                                <td class="text-primary" style="">
                                                 ...
                                                 <td class="text-primary">
                                                  <textarea class="form-control font-w-600" name="containerNo[]" id="containerNo<?php echo $sno;?>" style=" text-align: center;text-transform: uppercase;"><?php echo $value->containerNo; ?></textarea>
                                                 </td>
                                    ...
                                    <table class="display table dataTable  table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-primary">
                                                   <input type="number" placeholder="" class="form-control font-w-600 bookingInvoiceAmt" name="bookingInvoiceAmt[]" id="bookingInvoiceAmt<?php echo $sno;?>" value="<?php echo $value->bookingInvoiceAmt; ?>" style=" text-align: center;" onkeyup="expensesSum1();" required="">
                                                 </td>
                                                 <td class="text-primary">
                                                  <input type="number" placeholder="" class="form-control font-w-600 expensesDiesel" name="expensesDiesel[]" id="expensesDiesel<?php echo $sno;?>" value="<?php echo $value->expensesDiesel; ?>" style="text-align: center;" onkeyup="expensesSum1();">
                                                 </td>

                                                 <td class="text-primary">
                                                  <input type="number" placeholder="" class="form-control font-w-600 expensesToll" name="expensesToll[]" id="expensesToll<?php echo $sno;?>" value="<?php echo $value->expensesToll; ?>" style="text-align: center;" onkeyup="expensesSum1();">
                                                 </td>

                                                 <td class="text-primary">
                                                  <input type="number" placeholder="" class="form-control font-w-600 expensesOther1" name="expensesOther1[]" id="expensesOther1<?php echo $sno;?>" value="<?php echo $value->expensesOther1; ?>" style="text-align: center;" onkeyup="expensesSum1();">
                                                 </td>

                                                 <td class="text-primary">
                                                  <input type="number" placeholder="" class="form-control font-w-600 expensesTotal" name="expensesTotal[]" id="expensesTotal<?php echo $sno;?>" value="<?php echo $value->expensesTotal; ?>" readonly="" style="background: aliceblue;text-align: center;" >
                                                 </td>

                                                 <td class="text-primary" style="display: flex;">
                                                  <input type="number" placeholder="" class="form-control font-w-600 bookingTotalSaving" name="bookingTotalSaving[]" id="bookingTotalSaving<?php echo $sno;?>" value="<?php echo $value->bookingTotalSaving; ?>" readonly="" style="background: aliceblue;text-align: center;">
