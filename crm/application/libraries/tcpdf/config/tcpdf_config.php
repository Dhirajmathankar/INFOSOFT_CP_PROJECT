 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', dirname(__file__).'/../example/');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'EZZY Relocation');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'EZZY Relocation');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'EZZY Relocation');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "call: +91-999999999 | email : ezzyrelo@gmail.com | website : www.ezzyrelocation.com");
